...
tukuilocal.core_raidutil = "RaidLeader"
...
TukuiDB.CreatePanel(RaidUtilityPanel, TukuiDB.Scale(170), panel_height, "TOP", UIParent, "TOP", -400, panel_height + 2)
...
CreateButton("ShowButton", RaidUtilityPanel, "SecureHandlerClickTemplate", RaidUtilityPanel:GetWidth() / 2.5, TukuiDB.Scale(18), "TOP", UIParent, "TOP", -400, 2, tukuilocal.core_raidutil, nil)
ShowButton:SetAttribute("_onclick", [=[
 if select(5, self:GetPoint()) > 0 then
	 self:GetParent():ClearAllPoints()
	 self:GetParent():SetPoint("TOP", UIParent, "TOP", -400, 1)
	 self:ClearAllPoints()
	 self:SetPoint("TOP", UIParent, "TOP", -400, -100)
 else
	 self:GetParent():ClearAllPoints()
	 self:GetParent():SetPoint("TOP", UIParent, "TOP", -400, 500)
	 self:ClearAllPoints()
	 self:SetPoint("TOP", UIParent, "TOP", -400, 1)
 end
]=])
