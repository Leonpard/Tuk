		...
		for i = 1, #guildTable do
			...
			if connected and name ~= T.myname then
				...
				if IsShiftKeyDown() then
					...
					GameTooltip:AddDoubleLine(string.format(levelNameStatusString, levelc.r*255, levelc.g*255, levelc.b*255, level, name, status, note, rank), zone, classc.r,classc.g,classc.b, zonec.r,zonec.g,zonec.b)
				end
			end
		end
	end
